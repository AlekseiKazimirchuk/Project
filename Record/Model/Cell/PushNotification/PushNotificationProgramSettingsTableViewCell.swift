//
//  PushNotificationProgramSettingsTableViewCell.swift
//  Record
//
...
class PushNotificationProgramSettingsTableViewCell: UITableViewCell {
   ...
   let cellNameArray = ["На завтра (вечерние)","На сегодня (утренние)"]
