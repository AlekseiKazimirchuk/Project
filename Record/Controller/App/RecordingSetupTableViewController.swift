//
//  RecordingSetupTableViewController.swift
//  Record
//
...
class RecordingSetupTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
            ...
            tableView.register(RecordingSetupTableViewCell.self, forCellReuseIdentifier: idOptionsSheduleCell)
