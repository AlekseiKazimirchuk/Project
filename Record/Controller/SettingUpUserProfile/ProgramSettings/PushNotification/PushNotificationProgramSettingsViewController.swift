//
//  PushNotificationProgramSettingsViewController.swift
//  Record
//
...
class PushNotificationProgramSettingsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
            ...
            tableView.register(PushNotificationProgramSettingsTableViewCell.self, forCellReuseIdentifier: idOptionsSheduleCell)
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
       ...
       override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: idOptionsSheduleCell, for: indexPath) as! PushNotificationProgramSettingsTableViewCell
