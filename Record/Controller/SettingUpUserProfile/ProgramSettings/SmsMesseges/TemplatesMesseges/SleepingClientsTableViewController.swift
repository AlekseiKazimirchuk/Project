//
//  SleepingClientsTableViewController.swift
//  Record
//
...
class SleepingClientsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
            ...
            tableView.register(SleepingClientsTableViewCell.self, forCellReuseIdentifier: idOptionsSheduleCell)
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
       ...
       override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: idOptionsSheduleCell, for: indexPath) as! SleepingClientsTableViewCell
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let cell = tableView.cellForRow(at: indexPath) as! SleepingClientsTableViewCell
