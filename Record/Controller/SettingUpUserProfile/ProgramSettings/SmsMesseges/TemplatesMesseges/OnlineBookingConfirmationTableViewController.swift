//
//  OnlineBookingConfirmationTableViewController.swift
//  Record
//
...
class OnlineBookingConfirmationTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
            ...
            tableView.register(OnlineBookingConfirmationTableViewCell.self, forCellReuseIdentifier: idOptionsSheduleCell)
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
       ...
       override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: idOptionsSheduleCell, for: indexPath) as! OnlineBookingConfirmationTableViewCell
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let cell = tableView.cellForRow(at: indexPath) as! OnlineBookingConfirmationTableViewCell
